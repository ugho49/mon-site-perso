...
<div class="parallax-container scrollspy" id="home">
    <div id="languages">
        <img src="{{ URL::to('/build/images/icons/flags/France.png') }}" data-id="fr" data-url="{{ URL::route('changeLocale', 'fr') }}" class="language_flag @if(App::isLocale('fr')) active @endif">
        <img src="{{ URL::to('/build/images/icons/flags/United-Kingdom.png') }}" data-id="en" data-url="{{ URL::route('changeLocale', 'en') }}" class="language_flag @if(App::isLocale('en')) active @endif">
    </div>
